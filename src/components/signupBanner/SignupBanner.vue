<template>
  <section class="signup-banner" :class="toggleBanner">
    <div v-if="!displaySignupCollapse && !signupSuccess" class="signup-banner__header util__flex--row" @click="toggleSignupForm">
      <span>
        Sign up for our latest news and promotions
      </span>
      <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
           viewBox="0 0 24 24" style="enable-background:new 0 0 24 24; fill: #ffffff; width: 24px; height: 24px; margin-left: 10px;" xml:space="preserve">
    ...
    <div v-if="displaySignupCollapse && !signupSuccess" class="signup-banner__form util__flex--column util__flex--center">
      <form>
        <div class="row util__flex--row">
          <div class="column util__flex--column">
    ...
    <div v-if="displaySignupCollapse && signupSuccess" class="signup-banner__sent util__flex--column util__flex--center">
