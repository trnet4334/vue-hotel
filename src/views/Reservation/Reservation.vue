<template>
  <div>
    ...
    <section class="checkout">
      <div class="checkout__container flex--row">
        <div class="checkout__main flex--column flex--center">
          <div class="checkout__header">
            <div class="checkout--alert flex--row">
            ...
            <div class="checkout__header--search flex--row" v-if="!isRoomSelected">
              <div class="flex--row search--col item-30">
              ...
              <div class="flex--row flex--center search--col item-30">
                <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
              ...
              <div class="flex--column flex--center search--col item-30">
            ...
            <div class="checkout__header--breadcrumb flex--column">
              <h1>{{steps[3]}}</h1>
              <div>
                <el-steps
                  :active="3"
