      ...
      <div class="room-details__container">
        <div class="room-details__body--first util__flex--row">
          <div class="room-details__image">
            <img src="@/assets/images/room/deluxe-guestroom-img.jpg" alt="#">
          </div>
          <div class="room-details__content--first">
            <h4 class="util__header--title">{{deluxeGuestroom.name}}</h4>
            <h1 class="util__header--subtitle">{{deluxeGuestroom.title}}</h1>
            <p class="util__header--description">{{deluxeGuestroom.description}}</p>
            <br>
            <p class="util__header--description">{{deluxeGuestroom.description2}}</p>
            <button>
