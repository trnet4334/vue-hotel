      ...
      <div class="room-details__container">
        <div class="room-details__body--first flex--row">
          ...
          <div class="room-details__content--first">
            <h4 class="content__title">{{theSpaSuite.name}}</h4>
            <h1 class="page__title">{{theSpaSuite.title}}</h1>
            <p class="content__description">{{theSpaSuite.description}}</p>
            <br>
            <p class="content__description">{{theSpaSuite.description2}}</p>
...
export default {
  ...
  data () {
    return {
      dialogVisible: false,
      imageUrl: ['room/the-spa-suite-img.jpg', 'The Spa Suite'],
      date: {
        start: '',
        end: ''
      },
